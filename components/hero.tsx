      ...
      <div className="relative container mx-auto px-4 py-20 md:py-28 lg:py-36">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative flex flex-col sm:flex-row gap-3 p-2 bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20">
              <div className="relative flex-1">
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                <Input
                  type="text"
                  placeholder="Buscar por cidade, tipo de evento ou fornecedor..."
                  className="pl-12 h-14 border-0 bg-transparent text-lg placeholder:text-gray-500 focus-visible:ring-0"
                />
              </div>
              <Button size="lg" className="btn-gradient h-14 px-8 text-lg font-semibold rounded-xl">
                Buscar
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
