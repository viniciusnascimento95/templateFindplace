  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
            ...
            {organizerFeatures.map((feature, index) => (
              <Card key={index} className="card-hover border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-brand-100 to-purple-100 rounded-lg flex items-center justify-center mb-4">
        ...
        {/* Para Fornecedores */}
        <div className="bg-gradient-to-br from-brand-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              ...
              <Card key={index} className="card-hover border-0 shadow-lg bg-white/90 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-brand-100 to-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                      <feature.icon className="h-6 w-6 text-brand-600" />
                    </div>
                    <div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-brand-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Segurança e Garantia</h3>
